            ...
            <Container size="wide">
                <div className="text-center mb-bz-lg">
                    ...
                    <p className="font-body text-bz-sm text-bz-beige/60 max-w-[480px] mx-auto mt-bz-xs">
                        No hacemos un solo tipo de negocio. Construimos el sistema que
                        el tuyo necesita.
                    </p>
                </div>
                <div className="flex justify-center items-center gap-bz-lg md:gap-bz-2xl flex-wrap">
                    {SECTORS.map((sector) => (
                        <div key={sector.name} className="text-center group">
                            <i className={`${sector.icon} text-3xl md:text-5xl text-bz-ambar transition-transform duration-200 group-hover:scale-110`} />
            ...
            <section className="min-h-screen pt-bz-2xl pb-bz-xl flex items-center">
                <Container size="wide">
                    ...
                    <p className="font-body text-bz-lead text-bz-grafito leading-[1.45] max-w-[560px] mt-bz-md mb-bz-lg">
                        Construimos herramientas a medida para pequeñas y medianas empresas.
                        Desde el CRM hasta la automatización. Sin suscripciones sorpresa,
                        sin dependencia de plataformas de terceros. Todo tuyo.
                    </p>
