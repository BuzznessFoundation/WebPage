            ...
            <Container size="narrow">
                ...
                <div className="flex flex-col gap-bz-md font-body text-bz-sm text-bz-grafito leading-[1.65]">
                    ...
                    <p>
                        ...
                        dirección de correo electrónico y el mensaje que nos envías. No
                        usamos cookies de tracking, analytics de terceros ni almacenamos
                        datos sin tu conocimiento.
                    </p>
                    ...
                    <p>
                        Usamos tu información exclusivamente para responder a tu consulta.
                        No compartimos, vendemos ni cedemos tus datos a terceros bajo
                    ...
                    <p>
                        Los mensajes se reciben directamente en nuestro correo. No se
                        almacenan en bases de datos ni en servidores intermedios. Si
                        deseas que eliminemos tu información después de la conversación,
