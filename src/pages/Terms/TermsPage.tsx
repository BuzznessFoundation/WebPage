        ...
        <>
            ...
            <Container size="narrow">
                ...
                <h1 className="font-display uppercase text-bz-negro leading-[0.95] text-[10vw] sm:text-bz-xl md:text-[56px] tracking-[-1px] mb-bz-md">
                    Términos y{' '}
                    <span className="text-bz-ambar">condiciones.</span>
                </h1>
                ...
                <div className="flex flex-col gap-bz-md font-body text-bz-sm text-bz-grafito leading-[1.65]">
                    ...
                    <p>
                        Buzzness ofrece servicios de desarrollo de software, automatización
                        de procesos, consultoría en infraestructura y productos de datos.
                        Cada proyecto se acuerda por escrito antes de comenzar, con alcance,
                        plazos y condiciones definidos.
                    </p>
                    ...
                    <p>
                        El código y los sistemas desarrollados para un cliente le pertenecen
                        al cliente una vez finalizado el proyecto y recibido el pago
                        completo, salvo acuerdo explícito en contrario. Buzzness se reserva
                        el derecho de mostrar el trabajo realizado en su portafolio, a menos
                        que el cliente solicite confidencialidad.
                    </p>
                    ...
                    <p>
                        ...
                        trabaja con un anticipo al inicio y pagos contra entregables. No
                        hay suscripciones ni cobros recurrentes por los sistemas
                        desarrollados, salvo servicios de mantenimiento acordados por
                        separado.
                    </p>
                    ...
                    <p>
                        ...
                        responsabilidad del cliente, salvo que se contrate un servicio
                        de soporte continuo.
                    </p>
